...
public class Add  implements java.io.Serializable {
    ...
    /**
     * Gets the intA value for this Add.
     * 
     * @return intA
     */
    public int getIntA() {
    ...
    /**
     * Sets the intA value for this Add.
     * 
     * @param intA
     */
    ...
    /**
     * Gets the intB value for this Add.
     * 
     * @return intB
     */
    public int getIntB() {
    ...
    /**
     * Sets the intB value for this Add.
     * 
     * @param intB
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://calculator.ws.asbaprin/", "add"));
