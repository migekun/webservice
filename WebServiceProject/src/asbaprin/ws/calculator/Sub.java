...
public class Sub  implements java.io.Serializable {
    ...
    /**
     * Gets the intA value for this Sub.
     * 
     * @return intA
     */
    public int getIntA() {
    ...
    /**
     * Sets the intA value for this Sub.
     * 
     * @param intA
     */
    ...
    /**
     * Gets the intB value for this Sub.
     * 
     * @return intB
     */
    public int getIntB() {
    ...
    /**
     * Sets the intB value for this Sub.
     * 
     * @param intB
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://calculator.ws.asbaprin/", "sub"));
